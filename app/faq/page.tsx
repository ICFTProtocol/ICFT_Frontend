...
const questions: Question[] = [
  ...
  { topic: "Getting started", question: "What assets can secure a position?", answer: "The current Sepolia release is limited to native ETH and wBTC. wstETH is disabled during oracle remediation. The dApp and status page are the source of truth for enabled assets." },
