...
export default function TokenomicsPage() {
  return <main className={styles.page}>
    ...
    <section className={`${styles.flow} shell`}><div><span className="kicker">TOKEN IN THE PROTOCOL</span><h2>ICFT connects<br />collateral to credit.</h2></div><div className={styles.flowSteps}><article><span>COLLATERAL</span><b>ETH · wBTC · wstETH</b><p>Users deposit approved assets to the LendingPool.</p></article><i>→</i><article><span>CREDIT</span><b>Borrow ICFT</b><p>Borrowing capacity is determined by risk limits and oracle prices.</p></article><i>→</i><article><span>REPAYMENT</span><b>ICFT returns</b><p>Principal returns to protocol inventory; interest follows the approved reserve policy.</p></article></div></section>
