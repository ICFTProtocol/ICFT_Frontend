...
const allocations = [
  ...
  ["Liquidity / LP", "150M", "15%", "Liquidity initiatives and market development."],
...
export default function TokenomicsPage() {
  return <main className={styles.page}>
    ...
    <section className={`${styles.principles} shell`}><article><span>01</span><h2>Fixed supply</h2><p>The ERC-20 supply is created once at deployment. The current contract does not provide an unrestricted mint function.</p></article><article><span>02</span><h2>Credit inventory</h2><p>Fund A is protocol lending inventory. It supplies the initial capital that allows borrowers to draw ICFT against collateral.</p></article><article><span>03</span><h2>Not a yield promise</h2><p>Token allocations and LP mechanics are not a guarantee of market liquidity, value, returns or a future listing.</p></article></section>
    ...
    <section className={`${styles.flow} shell`}><div><span className="kicker">TOKEN IN THE PROTOCOL</span><h2>ICFT connects<br />collateral to credit.</h2></div><div className={styles.flowSteps}><article><span>COLLATERAL</span><b>ETH · wBTC · wstETH</b><p>Users deposit approved assets to the LendingPool.</p></article><i>→</i><article><span>CREDIT</span><b>Borrow ICFT</b><p>Borrowing capacity is determined by risk limits and oracle prices.</p></article><i>→</i><article><span>REPAYMENT</span><b>ICFT returns</b><p>Borrower interest supports LP assets and the insurance reserve.</p></article></div></section>
